INSERT INTO animes (
    id, title, title_jp, tid, source, studio, summary, image_url
)
VALUES
(
...
(
    '83034b04-7957-47de-ad9e-0bfcf6aaf0f2', 'Wonder Egg Priority', 'Wonder Egg Priority JP', 73252, 'Light Novel', 'Studio DEEN', 'The ladettes in this one do solid damage at a decent pace. We got racial representation here which is pog.', 'https://i.pinimg.com/originals/d4/91/cc/d491cc571f429d5b6906569626bc89f9.png'
),
(
    '7537e893-0ed1-41fc-a4a8-d24ff904ed32', 'Re:Zero', 'Re:Zero JP', 13352, 'Light Novel', 'White Fox', 'First half is shit its actually painful to watch this man do whatever he does then to realize how he should be doing things its quite lame until it isnt.', 'https://i.pinimg.com/474x/fc/80/4c/fc804cfa92c187dca4d310f2af22b613.jpg'
),
(
...
(
    '44640e87-c422-499c-af60-1fe167b483fa', 'Akudama Drive', 'Akudama Drive JP', 99996, 'Original', 'Pierrot', 'Original anime that is actually good. You''re a loser if you didn''t watch this.', 'https://m.media-amazon.com/images/M/MV5BN2JiMGIzYjctMTcyZS00YjRiLWI0NWUtYzA1NjgyM2RlNDdkXkEyXkFqcGdeQXVyMzgxODM4NjM@._V1_.jpg'
),
(
    '2038daa3-250f-4855-abe3-d27b2bae099b', 'JoJo no Kimyou na Bouken', 'JoJo no Kimyou na Bouken JP', 99966, 'Manga', 'David Production', 'Very high levels of gay. If you watch this you''re lowkey fruity but at least you can appreciate a mans physique without it being too weird.', 'http://pm1.narvii.com/6270/e8162cb65b5c063580815947b4b7867d5dc9d62a_00.jpg'
),
(
    '5456c9f9-9159-4972-9128-1397a52dcbf8', 'Hajime no Ippo', 'Hajime no Ippo JP', 99966, 'Manga', 'God Himself', 'This might be the best sports anime ever made. Your brain gets dempsey rolled while watching.', 'https://media.kitsu.io/manga/poster_images/23/large.jpg?1434249443'
),
(
    '0e6808f5-72d9-4261-9d7b-89099bcb921e', 'Evangelion', 'Evangelion JP', 000001, 'Original', 'Satan Himself', 'Worst thing I have ever seen. If you''re pretentious and love to preten to like things give it a watch.', 'https://m.media-amazon.com/images/M/MV5BYjY1Y2ZmNDctZWQ3Yy00MTE3LTk2M2QtMjQ0MDA5ODVjMDEyXkEyXkFqcGdeQXVyNTA4NzY1MzY@._V1_UY1200_CR93,0,630,1200_AL_.jpg'
),
(
...
(
    'a0ee663b-f31b-4a7d-8064-2d073ec79fe1', 'One Punch Man', 'One Punch Man JP', 172201, 'Manga', 'Bones', 'Another goated anime thats unironically better than most animes made. Stop pretending to not have it in your top 10 just because its popular.', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQplKcInMv_cwCYL5u8oWiCJiGt3XAY1IrXcq1JdQVs0uTv1guQ95h_n_RePlnNBKBETcE&usqp=CAU'
),
(
    '9e39a3c5-0b99-4379-ab83-bfde1cd529bc', 'Baki', 'Baki JP', 173201, 'Manga', 'TMS Entertainment', 'Just a bunch of DUDES who are JACKED and HOT fighting each other. God tier combat sports anime.', 'https://m.media-amazon.com/images/M/MV5BMmQxZmRmNmUtZWUxNi00NzhiLWEwNzEtZTUyZWRhOWY5Yjg2XkEyXkFqcGdeQXVyMTAwMzM3NDI3._V1_.jpg'
);
